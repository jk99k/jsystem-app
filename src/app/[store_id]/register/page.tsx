...
export default function Register() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (formData.expectations.length === 0) {
      alert(
        "「百年蕎麦 壽」でどんな交流を期待しますか？を少なくとも1つ選んでください。"
      );
      return;
    }
  ...
  return (
    <div className="min-h-screen bg-[url('/img/background.png')] bg-cover bg-center bg-fixed relative">
      ...
      {/* メインコンテナ */}
      <div className="relative z-10 min-h-screen flex flex-col items-start justify-start p-4">
        {/* フォームオーバーレイ */}
          ...
          <div className="p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <section className="space-y-4">
                ...
                <div className="space-y-2">
                  <label className="block text-sm font-medium text-gray-700">
                    <span className="text-red-500 mr-1">*</span>「百年蕎麦
